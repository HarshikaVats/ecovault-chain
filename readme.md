...
- [watsonx Assistant](https://cloud.ibm.com/catalog/services/watsonx-assistant)
  ...
  <p align="justify">We have not only used the basic actions of WatsonX Orchestrate AI Assistant in our chatbot, but also <b>[created a custom-skill](./ecovault-chain-final-custom_skill.json)</b> json file, so that we can connect the chatbot to our backend and fetch results to aid the buyer in the best way possible</p>
